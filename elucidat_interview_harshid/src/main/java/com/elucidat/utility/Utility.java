package com.elucidat.utility;

import com.elucidat.browserfactory.ManageBrowser;
...
public class Utility extends ManageBrowser {
    ...
    public List<String> getTextFromListOfElements(List<WebElement> elements) {
    ...
    public void sendTextToElementAndPressEnterKey(WebElement element, String str) {
    ...
    //Until element to be clickable
    public WebElement waitUntilElementToBeClickable(WebElement element, int time) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
        return wait.until(ExpectedConditions.elementToBeClickable(element));
    }
    public  void waitUntilFormElementToBeVisibleByScrolling(WebElement element, int time) {
    //WebElement element = driver.findElement(By.id("loading image ID"));
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
    wait.until(ExpectedConditions.invisibilityOf(element));
    }

    public void waitUntilWebPageLinkToBeAvailable(String url, int time){
        WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(time));
        wait.until(ExpectedConditions.urlToBe(url));
    }

    public void waitUntilWebPageTextToBeVisible(String text, int time){
        WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(time));
